...
| `update` | 修改业务需求 | `PUT` | `/epics/{storyID}` |
| `delete` | 删除业务需求 | `DELETE` | `/epics/{storyID}` |
| `activate` | 激活业务需求 | `PUT` | `/epics/{storyID}/activate` |
| `change` | 变更业务需求 | `PUT` | `/epics/{storyID}/change` |
| `close` | 关闭业务需求 | `PUT` | `/epics/{storyID}/close` |
